      ...
      >
        ...
        <ul className="flex flex-wrap items-center flex-col mt-11 justify-evenly p-4 font-bold text-3xl ">
          <Link to="/" onClick={hideNav}>
            <li className="duration-300 ease rounded my-2 tracking-wider p-2 cursor-pointer hover:bg-black hover:text-white">
              HOME
            </li>
          </Link>
        ...
        <div className="flex flex-col justify-end h-[32%] items-center text-2xl mt-6">
          ...
          <Link to="/signup" onClick={hideNav}>
            <button className="px-4 my-1 pb-1 hover:text-white font-medium hover:bg-red-500 rounded duration-200 ease text-center">
              Signup
            </button>
          </Link>
        </div>
