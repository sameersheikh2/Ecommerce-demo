...
const ProductDetail = (props) => {
  ...
  return (
    <>
      <div className="relative flex my-[5rem] lg:max-w-[1320px] md:max-w-[750px] h-[auto] md:h-[auto] sm:h-[auto] mx-auto bg-white rounded-xl shadow-2xl">
        ...
        <div className="w-full p-5">
          ...
          <div className="flex items-center mt-4">
            <p className="flex items-center mx-4 p-1 pr-2 rounded font-medium bg-green-600 hover:scale-[1.02] cursor-pointer group">
      ...
      <div className="max-w-[1320px] h-auto py-2 flex rounded-3xl shadow-3xl mx-auto justify-center flex-wrap">
        <Review />
      </div>
    </>
  );
